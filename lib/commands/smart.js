...
function smartDeploy() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!files.length) {
            ...
            region = yield selectRegion();
            const envId = yield selectEnv(isInitNow);
            yield initProjectWithTemplate(envId, region);
        }
        ...
        if (!envId) {
            envId = yield selectEnv(isInitNow);
        ...
        yield callFramework(envId, config);
    });
}
exports.smartDeploy = smartDeploy;
function initProjectWithTemplate(envId, region, projectPath = process.cwd()) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!filepath) {
            fs_1.default.writeFileSync(path_1.default.join(projectPath, 'cloudbaserc.json'), JSON.stringify({ envId, region }));
        }
        else {
