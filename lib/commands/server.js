...
commander_1.default
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        servers.forEach((server) => __awaiter(this, void 0, void 0, function* () {
            ...
            yield new controller_1.NodeController(Object.assign({ envId }, sshConfig, server, credential)).deploy();
            return;
        }));
    });
});
commander_1.default
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const credential = yield utils_1.checkAndGetCredential();
        const sshConfig = yield utils_1.getSSH();
        yield new controller_1.NodeController(Object.assign({}, credential, sshConfig, server)).logs({
...
commander_1.default
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const credential = yield utils_1.checkAndGetCredential();
        const sshConfig = yield utils_1.getSSH();
        yield new controller_1.NodeController(Object.assign({}, sshConfig, server, credential)).reload();
        return;
    });
});
commander_1.default
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const credential = yield utils_1.checkAndGetCredential();
        const sshConfig = yield utils_1.getSSH();
        yield new controller_1.NodeController(Object.assign({}, credential, sshConfig, server)).delete();
    });
});
commander_1.default
    .command('server:show')
    ...
    return __awaiter(this, void 0, void 0, function* () {
        const credential = yield utils_1.checkAndGetCredential();
        const sshConfig = yield utils_1.getSSH();
        yield new controller_1.NodeController(Object.assign({}, credential, sshConfig)).show();
    });
});
