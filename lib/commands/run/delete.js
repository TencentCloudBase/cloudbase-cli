...
let DeleteRun = class DeleteRun extends common_1.Command {
    ...
    execute(envId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            loading.start('数据加载中...');
            const versions = yield run_1.listVersion({ envId, serverName: serviceName });
            ...
            const res_run = yield run_1.deleteRun({ envId, serverName: serviceName });
            if (res_run === 'succ')
            ...
            if ((yield enquirer_1.prompt({
                ...
                const res_repo = yield run_1.deleteImageRepo({ imageRepo });
                if (res_repo === '')
