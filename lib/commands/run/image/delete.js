...
let DeleteImage = class DeleteImage extends common_1.Command {
    ...
    execute(envId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const imageUrl = yield utils_1.pagingSelectPromp('select', run_1.listImage, { envId, serviceName, limit: 0, offset: 0 }, '请选择要删除的镜像', item => item.ReferVersions.length === 0, item => item.ImageUrl);
            try {
