    ...
    execute(envId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let sh = new Promise((resolve, reject) => {
                child_process_1.exec(`docker push ccr.ccs.tencentyun.com/${imageRepo}:${imageTag}`, (stderr, stdout) => stderr ? reject(stderr) : resolve({ code: 0, info: stdout })).stdout.pipe(process.stdout);
            });
            yield sh;
