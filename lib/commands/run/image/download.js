...
let DownLoadImage = class DownLoadImage extends common_1.Command {
    ...
    execute(envId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let sh = new Promise((resolve, reject) => child_process_1.exec(`docker pull ${imageUrl}`, (err, stdout) => err ? reject({ code: -1, info: err }) : resolve({ code: 0, info: stdout })).stdout.pipe(process.stdout));
            let res = yield sh;
            if (res.code === -1)
