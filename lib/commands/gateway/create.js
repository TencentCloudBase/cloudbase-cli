...
let CreateService = class CreateService extends common_1.Command {
    ...
    execute(envId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            validator_1.assertTruthy(servicePath, '请指定需要创建的HTTP 访问服务路径！');
            ...
            try {
                ...
                const res = yield gateway_1.queryGatewayDomain({ envId });
                const link = utils_1.genClickableLink(`https://${res.DefaultDomain}${servicePath}`);
