...
let NewCommand = class NewCommand extends common_1.Command {
    ...
    execute(ctx, log) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            const { params } = ctx;
            const appName = params === null || params === void 0 ? void 0 : params[0];
            const templateUrl = params === null || params === void 0 ? void 0 : params[1];
            ...
            if (templateUrl && isGitUrl(templateUrl)) {
                yield execa_1.default('git', ['clone', templateUrl, appName], {
                    stdio: 'inherit'
                });
