...
let AttachFileLayer = class AttachFileLayer extends common_1.Command {
    get options() {
        return Object.assign(Object.assign({}, common_2.layerCommonOptions('bind <name>')), { deprecateCmd: 'functions:layer:bind <name>', options: [
                {
                    flags: '-e, --envId <envId>',
                    desc: '环境 Id'
                },
    ...
    execute(envId, params, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            loading.start('数据加载中...');
            const envFunctions = yield function_1.listFunction({
                envId
            });
...
__decorate([
    ...
    __param(0, decorators_1.EnvId()), __param(1, decorators_1.ArgsParams()), __param(2, decorators_1.ArgsOptions()),
...
let UnAttachFileLayer = class UnAttachFileLayer extends common_1.Command {
    get options() {
        return Object.assign(Object.assign({}, common_2.layerCommonOptions('unbind <name>')), { deprecateCmd: 'functions:layer:unbind <name>', options: [
                {
                    flags: '-e, --envId <envId>',
                    desc: '环境 Id'
                },
