...
const commands = [
    {
        ...
        desc: '展示云函数列表',
        handler: (envId, options) => __awaiter(this, void 0, void 0, function* () {
    ...
    },
    {
        ...
        desc: '部署云函数',
        handler: (name, envId, options) => __awaiter(this, void 0, void 0, function* () {
            const { configFile } = options.parent;
    ...
    },
    {
        ...
        options: [],
        desc: '触发云函数',
        handler: (name, jsonStringParams, envId, options) => __awaiter(this, void 0, void 0, function* () {
            const { configFile } = options.parent;
            const ctx = yield getFunctionContext(name, envId, configFile);
    ...
    },
    {
        ...
        desc: '拷贝云函数',
        handler: (functionName, newFunctionName, envId, targentEnvId, options) => __awaiter(this, void 0, void 0, function* () {
            const { configFile } = options.parent;
    ...
    },
    {
        ...
        options: [],
        desc: '删除云函数触发器',
        handler: (functionName, triggerName, envId, options) => __awaiter(this, void 0, void 0, function* () {
            const { configFile } = options.parent;
            const ctx = yield getFunctionContext(functionName, envId, configFile);
