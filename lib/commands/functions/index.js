...
function getFunctionContext(name, options) {
    var _a, _b;
...
const commands = [
    {
        ...
        handler: (options) => __awaiter(void 0, void 0, void 0, function* () {
            const ctx = yield getFunctionContext('', options);
    ...
    },
    {
        ...
        desc: '下载云函数代码',
        handler: (name, dest, options) => __awaiter(void 0, void 0, void 0, function* () {
            const ctx = yield getFunctionContext(name, options);
    ...
    },
    {
        ...
        desc: '部署云函数',
        handler: (name, options) => __awaiter(void 0, void 0, void 0, function* () {
            const ctx = yield getFunctionContext(name, options);
    ...
    },
    {
        ...
        desc: '拷贝云函数',
        handler: (functionName, newFunctionName, options) => __awaiter(void 0, void 0, void 0, function* () {
            const { target } = options;
            const ctx = yield getFunctionContext(functionName, options);
            yield copy_1.copy(ctx, newFunctionName, target, options);
        })
    },
    {
    ...
    },
    {
        ...
        desc: '删除云函数触发器',
        handler: (functionName, triggerName, options) => __awaiter(void 0, void 0, void 0, function* () {
            const ctx = yield getFunctionContext(functionName, options);
    ...
    },
    {
        ...
        handler: (name, options) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const ctx = yield getFunctionContext(name, options);
            yield invoke_1.invoke(ctx, params);
        })
    },
    {
        cmd: 'functions:run',
