...
function debugByConfig(ctx, name) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const handlers = (((_a = funcConfig) === null || _a === void 0 ? void 0 : _a.handler) || 'index.js').split('.');
        ...
        const args = debug ? [...debugArgs, bootstrapFilePath] : [bootstrapFilePath];
        spawnNodeProcess(args, {
            env: Object.assign(Object.assign(Object.assign({}, process.env), { SCF_FUNCTION_HANDLER: ((_b = funcConfig) === null || _b === void 0 ? void 0 : _b.handler) || 'index.main', SCF_FUNCTION_NAME: ((_c = funcConfig) === null || _c === void 0 ? void 0 : _c.name) || 'main', GLOBAL_USER_FILE_PATH: path_1.default.join(debugDirname, path_1.default.sep), SCF_EVENT_BODY: params || JSON.stringify(((_d = funcConfig) === null || _d === void 0 ? void 0 : _d.params) || {}) }), (_e = funcConfig) === null || _e === void 0 ? void 0 : _e.envVariables)
        });
    });
}
