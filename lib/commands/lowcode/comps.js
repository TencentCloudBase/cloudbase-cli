...
let LowCodeDebugComps = class LowCodeDebugComps extends common_1.Command {
    ...
    execute(ctx, options, log) {
        return __awaiter(this, void 0, void 0, function* () {
            const config = ctx.config.lowcodeCustomComponents;
            if (config) {
                yield lowcode_cli_1.graceDebugComps(Object.assign(Object.assign({}, config), { context: config.context || process.cwd(), debugPort: (options === null || options === void 0 ? void 0 : options.debugPort) || 8388, logger: log, wxDevtoolPath: options === null || options === void 0 ? void 0 : options.wxDevtoolPath }));
                return;
            }
            const compsPath = path_1.default.resolve(process.cwd());
...
function _install(compsPath) {
    return __awaiter(this, void 0, void 0, function* () {
        const res = yield utils_1.execWithLoading(() => __awaiter(this, void 0, void 0, function* () {
            ...
            yield util_1.promisify(child_process_1.exec)(['npm install', ...npmOptions].join(' '), {
                cwd: compsPath,
                env: process.env,
            });
        }), {
