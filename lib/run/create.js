...
const createRun = (options) => __awaiter(void 0, void 0, void 0, function* () {
    const { Result } = yield tcbService.request('EstablishCloudBaseRunServer', Object.assign({
        EnvId: options.envId,
    ...
    }, options.imageRepo ? { ImageRepo: options.imageRepo } : {}, options.logType === 'es' ? { EsInfo: options.esInfo } : {}));
    return Result;
});
