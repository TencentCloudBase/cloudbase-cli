...
class FunctionPacker {
    ...
    getFileCode() {
        return __awaiter(this, void 0, void 0, function* () {
            toolbox_1.checkFullAccess(this.funcPath, true);
            ...
            yield toolbox_1.zipDir(this.funcPath, zipPath, this.ignore);
    ...
    getJavaFileCode() {
        const { funcPath } = this;
        const jarExist = toolbox_1.checkFullAccess(`${funcPath}.jar`);
        const zipExist = toolbox_1.checkFullAccess(`${funcPath}.zip`);
