        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (fs_2.checkFullAccess(oldConfigPath)) {
                try {
                    ...
                    yield db.set(constant_1.ConfigItems.credentail, credential).write();
...
function getUin() {
    return __awaiter(this, void 0, void 0, function* () {
        const credentail = yield exports.authStore.get(constant_1.ConfigItems.credentail);
        return (credentail === null || credentail === void 0 ? void 0 : credentail.uin) || '无';
    });
}
