...
function resolveCloudBaseConfig(configPath = '') {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const cloudbasePath = [customConfigPath, cloudbaseJSPath, cloudbaseJSONPath].find(item => item && fs_1.default.existsSync(item));
        if (!cloudbasePath || !fs_1.default.existsSync(cloudbasePath) || !cloudbasePath.match(/.js$|.json$/g)) {
            return {};
        }
        ...
        cloudbaseConfig.functions = cloudbaseConfig.functions.map(config => (Object.assign(Object.assign({}, DefaultFunctionDeployOptions), config)));
