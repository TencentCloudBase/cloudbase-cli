...
class CreateFunctionTestModelRequest extends  AbstractModel {
    ...
    deserialize(params) {
        ...
        this.TestModelName = 'TestModelName' in params ? params.TestModelName : null;
        this.TestModelValue = 'TestModelValue' in params ? params.TestModelValue : null;
...
class GetFunctionTotalNumResponse extends  AbstractModel {
    ...
    deserialize(params) {
        ...
        this.FunctionTotalNum = 'FunctionTotalNum' in params ? params.FunctionTotalNum : null;
        this.RequestId = 'RequestId' in params ? params.RequestId : null;
...
class Subscription extends  AbstractModel {
    ...
    deserialize(params) {
        ...
        this.DeviceId = 'DeviceId' in params ? params.DeviceId : null;
        this.SubscriptionDefinitionId = 'SubscriptionDefinitionId' in params ? params.SubscriptionDefinitionId : null;
        this.Source = 'Source' in params ? params.Source : null;
        this.Target = 'Target' in params ? params.Target : null;
        this.AddTime = 'AddTime' in params ? params.AddTime : null;
        this.ModTime = 'ModTime' in params ? params.ModTime : null;
...
class AccountUsage extends  AbstractModel {
    ...
    deserialize(params) {
        ...
        this.FunctionCount = 'FunctionCount' in params ? params.FunctionCount : null;
...
class GetDemoDetailRequest extends  AbstractModel {
    ...
    deserialize(params) {
        ...
        this.InternationalLanguage = 'InternationalLanguage' in params ? params.InternationalLanguage : null;
...
class UpdateFunctionQuotaRequest extends  AbstractModel {
    ...
    deserialize(params) {
        ...
        this.FunctionName = 'FunctionName' in params ? params.FunctionName : null;
        this.ContainerMinNum = 'ContainerMinNum' in params ? params.ContainerMinNum : null;
        this.ContainerMaxNum = 'ContainerMaxNum' in params ? params.ContainerMaxNum : null;
        this.UserAppId = 'UserAppId' in params ? params.UserAppId : null;
        this.Namespace = 'Namespace' in params ? params.Namespace : null;
        this.UserUin = 'UserUin' in params ? params.UserUin : null;
...
class DescribeSubscriptionDefinitionRequest extends  AbstractModel {
    ...
    deserialize(params) {
        ...
        this.DeviceId = 'DeviceId' in params ? params.DeviceId : null;
        this.SubscriptionDefinitionIds = 'SubscriptionDefinitionIds' in params ? params.SubscriptionDefinitionIds : null;
        this.Limit = 'Limit' in params ? params.Limit : null;
        this.Offset = 'Offset' in params ? params.Offset : null;
        this.Order = 'Order' in params ? params.Order : null;
        this.Orderby = 'Orderby' in params ? params.Orderby : null;
...
class InnerModifyUserRestrictionRequest extends  AbstractModel {
    ...
    deserialize(params) {
        ...
        this.UserAppId = 'UserAppId' in params ? params.UserAppId : null;
        this.UserUin = 'UserUin' in params ? params.UserUin : null;
        this.RestrictionName = 'RestrictionName' in params ? params.RestrictionName : null;
        this.RestrictionValue = 'RestrictionValue' in params ? params.RestrictionValue : null;
        this.Namespace = 'Namespace' in params ? params.Namespace : null;
